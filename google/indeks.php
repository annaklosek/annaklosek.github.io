        ...
        <div id="start" :class="{results : aktywne()}">
            ...
            <main>
                ...
                <div class="m-flex_container">
                    ...
                    <div class="liczba_wynikow" style="margin-top:-50px;">Około 15 200 000 wyników (0,45 s)</div>
                    ...
                    <div class="wynik">
                        <div class="naglowek" style="margin-top:-30px;">
                            <div class="hiperlacze">
                                ...
                                <a class="tytul" href="https://support.google.com/websearch/answer/1710607?co=GENIE.Platform%3DAndroid&hl=pl">Sprawdzanie wyników wyszukiwania podróży przez Gmaila ...</a>
                            </div>
                        </div>
                        ...
                        <div class="naglowek">
                            <div class="hiperlacze">
                                <div class="adres">
                                    <cite class="skrot">
                                        www.youtube.com
                                        <span class="rodzaj"> › blog › jak-wyszukiwac-w-google</span>
                                    </cite>
                                </div>
                        ...
                        <div class="naglowek">
                            <div class="hiperlacze">
                                <div class="adres">
                                    <cite class="skrot">
                                        https://ks.pl
                                        <span class="rodzaj"> › jak-sprawdzic-pozycje-strony-w-google</span>
                                    </cite>
                                </div>
                    ...
                    <div class="wynik">
                        <div class="naglowek">
                            <div class="hiperlacze">
                                <div class="adres">
                                    <cite class="skrot">
                                        https://blog.csgroup.pl
                                        <span class="rodzaj"> › Blog</span>
                                    </cite>
                                </div>
                                <a class="tytul" href="https://blog.csgroup.pl/wyszukiwarka-google/google-favicon-update-czyli-zmiana-w-sposobie-wyswietlania-wynikow-wyszukiwania/">Google Favicon Update. Zmiana w sposobie wyświetlania ...</a>
                            </div>
                        </div>
        
                        <div class="streszczenie">
                            <span class="opis">
                                20 sty 2020 — Tym razem w sieci niosą się wieści, że nowa aktualizacja dotyczyć będzie zmiany w sposobie wyświetlania wyników wyszukiwania.
                            </span>
                        </div>
                    </div>    
                </div>                   
